...
Запустить — одна команда, раздел «Как запустить». Что решение **не** делает —
раздел «Границы решения», он написан до того, как вы это спросите. Сохранённые
отчёты замеров — каталог `measurements/`.
