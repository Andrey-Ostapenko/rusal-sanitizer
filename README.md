...
`bench_model` на схемах не показан: он ни от чего в решении не зависит,
кроме разбора дампа, и в санитизации не участвует.
...
| `bench_model` | замер модели на демо-данных, отдельный инструмент |
