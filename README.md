...
| Обработка сумм | механизм проверен, в конфиг не включён. Ответ получен 15.09: перечня конфиденциальных данных нет, трактовка на исполнителе, чистятся обе категории |
