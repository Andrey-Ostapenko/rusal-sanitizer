...
def parse_schema(path):
    ...
    В keys попадают колонки первичного, уникального и внешнего ключа —
    включая ту сторону внешнего ключа, на которую ссылаются из другой
    таблицы. Обычный `KEY` (индекс) сюда НЕ входит: см. KEY_COLS выше.
    """
